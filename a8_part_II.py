...
def get_planet_radius(planet_name: str) -> str:
    ...
    print(infobox_text)
    # TODO: fill this in
    pattern = "Mean radius(?P<mean_radius>[\d.]+"
    error_text = "Page infobox has no polar radius information"
    match = get_match(infobox_text, pattern, error_text)
...
if __name__ == "__main__":
    print("\n<<<<<<<<<<<<<< Testing Planet Mean Density >>>>>>>>>>>>>>")
    print(f'Mars has a mean density of {get_planet_mean_density("Mars")}g/cm^3 ||| Should be: 3.9335g/cm^3')
    print(f'Earth has a mean density of {get_planet_mean_density("Earth")}g/cm^3 ||| Should be: 5513g/cm^3')
    print(f'Jupiter has a mean density of {get_planet_mean_density("Jupiter")}g/cm^3 ||| Should be: 1.326g/cm^3')
    print(f'Saturn has a mean density of {get_planet_mean_density("Saturn")}g/cm^3 ||| Should be: 0.687g/cm^3')
